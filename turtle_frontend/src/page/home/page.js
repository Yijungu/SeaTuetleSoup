  ...
  return (
    <div className="e4_2">
      ...
      <div className="e186_174">
        ...
        <p className="e186_178">A. 전세계 곳곳에서 유행 중인 나폴리탄 괴담 계열의 수수께끼입니다.</p>
        <p className="e186_178_2">보통 기묘한 내용을 바탕으로 만들어지는 추리 놀이입니다.</p>
      </div>
      ...
      <div className="e186_179">
        ...
        <p className="e186_178">A. 출제자가 이야기 형식의 수수께끼를 만들어 출제합니다. 참가자들은 출제자에게 예 또는 아니오로 대답할 수 있는 질문을 하고, 출제자는 그에 대한 대답을 합니다.                                                                                                           
정보를 통해 참가자들은 이야기의 전말을 추리합니다. 가장 답에 가까운 질문을 하게 되는 때가 오면 출제자는 정답을 공개합니다.</p>
      </div>
     ...
     정답 단어는 국제 표준시(UTC) 기준 매일 오후 3시 또는 한국 표준시(KST) 기준 자정에 바뀝니다.</span>
      ...
      <div className="e186_194">
        ...
        <span className="e186_178">A. 질문이나 피드백은 F22F 메일로 문의해주세요!</span>
      </div>
    </div>
  )
}
