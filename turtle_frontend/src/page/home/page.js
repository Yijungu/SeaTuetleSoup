      ...
      <div className="container">
        <div className="e4_2">
          ...
          <div className="e186_185">
            ...
            <p className="e186_178">
              A. 플레이한 기록은 우측 상단의 ‘log’에서 볼 수 있습니다. 홈
              화면에서 닉네임을 입력하면 어쩌고~
            </p>
          </div>
          ...
          <div className="e186_191">
            ...
            <span className="e186_178">
              ...
              꼬맨틀과 같은 게임의 핵심 요소는 &quot;하루에 한 번만, 모두가
              동일한 정답&quot;이라고 생각합니다. 정답 단어는 국제 표준시(UTC)
              기준 매일 오후 3시 또는 한국 표준시(KST) 기준 자정에 바뀝니다.
            </span>
          </div>
